...
public class ChangeManagerAPITest extends AbstractRestTest {
  ...
  private static final String CORRECT_INITIAL_RECORD_SOURCE_RECORD_ID_1 = UUID.randomUUID().toString();
  private static final String CORRECT_INITIAL_RECORD_SOURCE_RECORD_ID_2 = UUID.randomUUID().toString();
  private static final String CORRECT_INITIAL_RECORD_SOURCE_RECORD_ID_3 = UUID.randomUUID().toString();
  
  private static final String CORRECT_INITIAL_RECORD_INSTANCE_ID_1 = UUID.randomUUID().toString();
  private static final String CORRECT_INITIAL_RECORD_INSTANCE_ID_2 = UUID.randomUUID().toString();
  private static final String CORRECT_INITIAL_RECORD_INSTANCE_ID_3 = UUID.randomUUID().toString();
  
  private static final boolean CORRECT_INITIAL_RECORD_SUPPRESS_DISCOVERY_1 = false;
  private static final boolean CORRECT_INITIAL_RECORD_SUPPRESS_DISCOVERY_2 = false;
  private static final boolean CORRECT_INITIAL_RECORD_SUPPRESS_DISCOVERY_3 = false;
  
  private static final InitialRecord CORRECT_INITIAL_RECORD_1 = new InitialRecord();
  private static final InitialRecord CORRECT_INITIAL_RECORD_2 = new InitialRecord();
  private static final InitialRecord CORRECT_INITIAL_RECORD_3 = new InitialRecord();

  static {
	  CORRECT_INITIAL_RECORD_1.setRecord(CORRECT_RAW_RECORD_1);
	  CORRECT_INITIAL_RECORD_1.setSourceRecordId(CORRECT_INITIAL_RECORD_SOURCE_RECORD_ID_1);
	  CORRECT_INITIAL_RECORD_1.setInstanceId(CORRECT_INITIAL_RECORD_INSTANCE_ID_1);
	  CORRECT_INITIAL_RECORD_1.setSuppressDiscovery(CORRECT_INITIAL_RECORD_SUPPRESS_DISCOVERY_1);

	  CORRECT_INITIAL_RECORD_2.setRecord(CORRECT_RAW_RECORD_2);
    CORRECT_INITIAL_RECORD_2.setSourceRecordId(CORRECT_INITIAL_RECORD_SOURCE_RECORD_ID_2);
    CORRECT_INITIAL_RECORD_2.setInstanceId(CORRECT_INITIAL_RECORD_INSTANCE_ID_2);
    CORRECT_INITIAL_RECORD_2.setSuppressDiscovery(CORRECT_INITIAL_RECORD_SUPPRESS_DISCOVERY_2);

    CORRECT_INITIAL_RECORD_3.setRecord(CORRECT_RAW_RECORD_3);
    CORRECT_INITIAL_RECORD_3.setSourceRecordId(CORRECT_INITIAL_RECORD_SOURCE_RECORD_ID_3);
    CORRECT_INITIAL_RECORD_3.setInstanceId(CORRECT_INITIAL_RECORD_INSTANCE_ID_3);
    CORRECT_INITIAL_RECORD_3.setSuppressDiscovery(CORRECT_INITIAL_RECORD_SUPPRESS_DISCOVERY_3);
  }
  ...
  private static final String INITIAL_RECORD_RESULTING_IN_PARSING_ERROR_SOURCE_RECORD_ID = UUID.randomUUID().toString();
  private static final String INITIAL_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR_SOURCE_RECORD_ID = UUID.randomUUID().toString();
  
  private static final String INITIAL_RECORD_RESULTING_IN_PARSING_ERROR_INSTANCE_ID = UUID.randomUUID().toString();
  private static final String INITIAL_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR_INSTANCE_ID = UUID.randomUUID().toString();
  
  private static final boolean INITIAL_RECORD_RESULTING_IN_PARSING_ERROR_SUPPRESS_DISCOVERY = false;
  private static final boolean INITIAL_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR_SUPPRESS_DISCOVERY = false;
  
  private static final InitialRecord INITIAL_RECORD_RESULTING_IN_PARSING_ERROR = new InitialRecord();
  private static final InitialRecord INITIAL_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR = new InitialRecord();
  
  static {
	  INITIAL_RECORD_RESULTING_IN_PARSING_ERROR.setRecord(RAW_RECORD_RESULTING_IN_PARSING_ERROR);	  
	  INITIAL_RECORD_RESULTING_IN_PARSING_ERROR.setSourceRecordId(INITIAL_RECORD_RESULTING_IN_PARSING_ERROR_SOURCE_RECORD_ID);
	  INITIAL_RECORD_RESULTING_IN_PARSING_ERROR.setInstanceId(INITIAL_RECORD_RESULTING_IN_PARSING_ERROR_INSTANCE_ID);
	  INITIAL_RECORD_RESULTING_IN_PARSING_ERROR.setSuppressDiscovery(INITIAL_RECORD_RESULTING_IN_PARSING_ERROR_SUPPRESS_DISCOVERY);

    INITIAL_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR.setRecord(RAW_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR);
    INITIAL_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR.setSourceRecordId(INITIAL_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR_SOURCE_RECORD_ID);
    INITIAL_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR.setInstanceId(INITIAL_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR_INSTANCE_ID);
    INITIAL_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR.setSuppressDiscovery(INITIAL_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR_SUPPRESS_DISCOVERY);
  }
  ...
  private RawRecordsDto rawRecordsDto = new RawRecordsDto()
    ...
    .withInitialRecords(Collections.singletonList(CORRECT_INITIAL_RECORD_1)
    );
  ...
  public void shouldProcessErrorRawRecords(TestContext testContext) {
    RawRecordsDto rawRecordsDtoContainingError = new RawRecordsDto()
      ...
      .withInitialRecords(asList(
        CORRECT_INITIAL_RECORD_2,
        INITIAL_RECORD_RESULTING_IN_PARSING_ERROR,
        CORRECT_INITIAL_RECORD_3));
  ...
  public void shouldProcessChunkOfRecordsAndFilterOutInvalidInstances(TestContext testContext) {
    RawRecordsDto rawRecordsDtoContainingError = new RawRecordsDto()
      ...
      .withInitialRecords(asList(
        CORRECT_INITIAL_RECORD_2,
        INITIAL_RECORD_RESULTING_IN_INSTANCE_MAPPING_ERROR,
        CORRECT_INITIAL_RECORD_3));
